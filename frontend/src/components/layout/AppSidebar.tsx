    ...
    >
      <div className="flex h-full flex-col">
        ...
        <nav className="flex-1 overflow-y-auto py-4 scrollbar-thin">
          {/* Logo - positioned just above Feed button */}
          <div className="px-3 mb-4">
            <div className={cn(
              'flex items-center py-2',
              collapsed ? 'justify-center' : 'gap-3'
            )}>
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-primary shadow-glow flex-shrink-0">
                <BookOpen className="h-4 w-4 text-primary-foreground" />
              </div>
              {!collapsed && (
                <div className="animate-fade-in flex-1 min-w-0">
                  <h1 className="text-sm font-bold text-sidebar-foreground leading-tight">Study Up</h1>
                  <p className="text-xs text-sidebar-foreground/60 leading-tight">Find your study buddy</p>
                </div>
              )}
            </div>
          </div>
        ...
        <button
          ...
          className="absolute -right-3 top-8 flex h-6 w-6 items-center justify-center rounded-full border border-sidebar-border bg-sidebar shadow-md hover:bg-sidebar-accent transition-colors"
        >
          {collapsed ? (
